...
<head>
    ...
    <style>
        /* Navbar Modern Touch from index.php */
        .navbar-custom {
...
<body style="background-image: url('assets/img/bg05.jpg'); background-size: cover; background-repeat: no-repeat; background-attachment: fixed; margin: 0; height: 100vh;">
     <!-- Navigation -->
