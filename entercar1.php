...
$Gear_type = $conn->real_escape_string($_POST['Gear_type']);
...
//$query = "INSERT into cars(car_name,car_nameplate,car_price,fuel_type,Gear_type,Engine,car_availability) VALUES('" . $car_name . "','" . $car_nameplate . "', '" . $car_price . "','" . $fuel_type . "','" . $Gear_type . "','" . $Engine . "','" . $car_availability ."')";
...
if (!empty($_FILES["uploadedimage"]["name"])) {
    ...
    if(move_uploaded_file($temp_name, $target_path)) {
      ...
      //  $query0 = "UPDATE cars SET car_img = '$target_path' WHERE ";
        ...
        $query = "INSERT into cars(car_name,car_nameplate,car_price,fuel_type,Gear_type,Engine,car_img,car_availability) VALUES('" . $car_name . "','" . $car_nameplate . "','" . $car_price . "','" . $fuel_type . "','" . $Gear_type . "','" . $Engine . "','".$target_path."','" .  $car_availability ."')";
        $success = $conn->query($query);
...
// Taking carId from cars

$query1 = "SELECT carId from cars where car_nameplate = '$car_nameplate'";
...
$query2 = "INSERT into clientcars(car_id,client_username) values('" . $carId ."','" . $_SESSION['login_client'] . "')";
